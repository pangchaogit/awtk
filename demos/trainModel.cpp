...
int main()
{
    ...
    model->save("../model/MyFacePCAModel.xml");//保存路径可自己设置，但注意用“\\”

    Ptr<BasicFaceRecognizer> model1 = FisherFaceRecognizer::create();
    model1->train(images, labels);
    model1->save("../model/MyFaceFisherModel.xml");

    Ptr<LBPHFaceRecognizer> model2 = LBPHFaceRecognizer::create();
    model2->train(images, labels);
    model2->save("../model/MyFaceLBPHModel.xml");
